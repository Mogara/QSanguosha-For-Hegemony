...
public:
    ...
    QList<int> askForMoveCards(ServerPlayer *zhuge, const QList<int> &cards, bool visible, const char *reason, const char *pattern, const char *skillName, bool moverestricted = false);
