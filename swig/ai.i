...
public:
    ...
    virtual QList<int>askForMoveCards(const QList<int> &upcards, const QList<int> &downcards, const char *reason, const char *pattern, int min_num, int max_num) = 0;
...
public:
    ...
    virtual QList<int>askForMoveCards(const QList<int> &upcards, const QList<int> &downcards, const char *reason, const char *pattern, int min_num, int max_num);
