...
public:
    ...
    virtual QList<int>askForMoveCards(const QList<int> &cards, const char *reason, const char *pattern) = 0;
...
public:
    ...
    virtual QList<int>askForMoveCards(const QList<int> &cards, const char *reason, const char *pattern);
