...
signals:
    ...
    void cardchoose(const QList<int> &card_ids, const QString &reason, const QString &pattern, bool moverestricted);
    ...
    void mirror_cardchoose_start(const QString &who, const QString &reason, const QList<int> &cards, const QString &pattern, bool moverestricted);
