...
public:
    ...
    QList<int> askForMoveCards(ServerPlayer *zhuge, const QList<int> &cards, bool visible, const QString &reason, LuaFunction f, const QString &skillName, bool optional = true);
