...
public:
    ...
    virtual QList<int>askForMoveCards(const QList<int> &cards, const QString &reason, const QString &pattern) = 0;
...
public:
    ...
    virtual QList<int>askForMoveCards(const QList<int> &cards, const QString &reason, const QString &pattern);
