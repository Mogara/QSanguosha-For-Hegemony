...
return {
	...
	["#bianhuanghou"] = "奕世之雍裔",
	["wanwei"] = "挽危",
	[":wanwei"] = "当你因被其他角色获得为手牌或弃置而失去牌时，你可以改为自己选择失去的牌。",
	["@wanwei"] = "你即将失去<font color=\"yellow\"><b>%src</b></font>，是否发动【<font color=\"yellow\"><b>挽危</b></font>】用 <font color=\"yellow\"><b>%dest</b></font> 张牌替换之？",
	["~wanwei"] = "选同等数量的牌后确定",
	["#wanwei"] = "%from 自主选择了因 %to 而 %arg2 的 %arg 张牌。",
	...
	["yingziextra"] = "英姿",
	["$FlameMapRemove"] = "%from 移除了“缘江烽火图”上的一张牌：%card",
