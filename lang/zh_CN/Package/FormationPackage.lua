...
return {
	...
	["&shengxi"] = "弃牌阶段开始时，若你于此回合内没有造成过伤害，你可以摸两张牌。",
	["shoucheng"] = "守成",
	...
	["#shangyi"] = "尚义 对 %to",
	["shangyi:hidden_general"] = "观看其暗置的武将牌",
	["shangyi:handcards"] = "观看其手牌并可以弃置其中的一张黑色牌",
	["niaoxiang"] = "鸟翔",
	...
	["&qianhuan"] = "每当与你势力相同的一名角色受到伤害后，若其存活，你可以将一张与你武将牌上花色均不相同的牌置于武将牌上，称为\"幻\"；" ..
					"每当与你势力相同的一名角色成为基本牌或锦囊牌的目标时，若目标数为1，你可以将一张\"幻\"置入弃牌堆，取消该角色。",
	["qianhuan:gethuan"] = "是否发动技能“千幻”将牌堆顶一张牌移出游戏成为“幻”？",
	["@qianhuan"] = "是否发动技能“千幻”将一张与你武将牌上花色均不相同的牌置于武将牌上？",
	["sorcery"] = "幻",
	...
	["dpRevive"] = "选择一张武将牌复活加入战斗",
	["#doDragonPhoenix"] = "%from 改变了武将牌",
	["#DragonPhoenixRevive"] = "%from 选择了 %arg 重新加入战斗",
}